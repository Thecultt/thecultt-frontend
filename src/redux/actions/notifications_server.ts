...
export const setIsNotificationServerError = (status: boolean, text?: string) => (dispatch: Dispatch<NotificationsServerActions>) => {
	if (text) {
		dispatch({
...
export const setIsNotificationServerSuccess = (status: boolean, text?: string) => (dispatch: Dispatch<NotificationsServerActions>) => {
	if (text) {
		dispatch({
