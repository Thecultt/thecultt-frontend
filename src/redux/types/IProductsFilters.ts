...
export type ProductsFiltersTypes = setProductsFiltersIsLoaded | setProductsFiltersPrice | setProductsFiltersConditions | setProductsFiltersCategory | setProductsFiltersColors