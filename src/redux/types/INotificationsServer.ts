...
export type NotificationsServerActions = setIsNotificationServerError | setNotificationServerErrorText | setIsNotificationServerSuccess | setNotificationServerSuccessText