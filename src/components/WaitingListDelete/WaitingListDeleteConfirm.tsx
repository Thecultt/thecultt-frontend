...
const WaitingListCreateSuccess: React.FC<WaitingListCreateSuccessProps> = ({ closeFunc, onSumbit }) => {
	return (
		<div className="cabinet-waiting-list-delete">
			<h2 className="cabinet-waiting-list-delete__title">
				Отписка
			</h2>
			...
			<div className="cabinet-waiting-list-delete-btn">
				<button className="btn-regular cabinet-waiting-list-delete-btn__btn" onClick={closeFunc}>Нет</button>
				<button className="btn cabinet-waiting-list-delete-btn__btn" onClick={onSumbit}>Да</button>
			</div>
		</div>
	);
};
