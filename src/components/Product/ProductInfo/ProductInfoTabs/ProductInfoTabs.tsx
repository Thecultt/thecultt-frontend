...
const ProductInfoTabs: React.FC = () => {
	const tabs = [
		...
		},
		{
			title: "Оплата",
			description: `
				<span>К оплате на сайте принимаются платежные системы: МИР, MasterCard, Visa, Maestro, UnionPay, YandexPay. Оплата наличными возможна только для услуги «Примерка по Москве».</span>
		...
		},
		{
			title: "Возврат",
			description: `
				<span>Мы принимаем возврат в течение трех дней с момента получения заказа (кроме заказов с методом доставки самовывоз).</span>
