...
const ProductInfoTabs: React.FC = () => {
	const tabs = [
		...
		},
		{
			title: "Оплата",
			description: `
				<span>К оплате на сайте принимаются платежные системы: МИР, MasterCard, Visa, Maestro, UnionPay, YandexPay. Заказы нельзя оплатить международной картой с платежной системой Visa, картами американских и украинских банков. Оплата наличными возможна только для услуги «Примерка по Москве».</span>
