...
const ProductInfoTitleBoutiquePopup: React.FC = () => {
	return (
		<div className='product-content-info-title-boutique-popup'>
			<h2 className="product-content-info-title-boutique-popup__title">
				Лот из бутика
			</h2>
			...
			<a href="/catalog?boutique=true" className="btn product-content-info-title-boutique-popup__btn">Смотреть все</a>
		</div>
	)
}
