...
import { Popup, ProductInfoTitlePartnerPopup } from 'src/components';

const ProductInfoTitlePartner: React.FC = () => {
	...
	return (
		<div className="product-content-info-title-boutique">
			...
			<Popup state={isStatePopup} setState={() => setIsStatePopup(!isStatePopup)}>
...
export default ProductInfoTitlePartner;
