...
const ProductCover: React.FC<ProductCoverProps> = ({ images }) => {
	...
	const [offset, setOffset] = React.useState<{ left: number, top: number }>({ left: 0, top: 0 });
			...
			<div className="product-content-cover">
				<div className="product-content-cover-list-wrapper">
					{!isStartSlider ? (
						<button className="product-content-cover-list__nav top" onClick={onClickSwiperPrev}>
							<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
								<rect x="29.3999" width="29.4" height="29.4" rx="14.7" transform="rotate(90 29.3999 0)" fill="#F7F4F0" />
								<path d="M18.3491 16.5L13.8491 12.5L9.34912 16.5" fill="#F7F4F0" />
								<path d="M18.3491 16.5L13.8491 12.5L9.34912 16.5" stroke="#202020" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
							</svg>
						</button>
					) : null}
					...
					{!isEndSlider ? (
						<button className="product-content-cover-list__nav bottom" onClick={onClickSwiperNext}>
							<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
								<rect y="29.3984" width="29.4" height="29.4" rx="14.7" transform="rotate(-90 0 29.3984)" fill="#F7F4F0" />
								<path d="M11.0508 12.8984L15.5508 16.8984L20.0508 12.8984" fill="#F7F4F0" />
								<path d="M11.0508 12.8984L15.5508 16.8984L20.0508 12.8984" stroke="#202020" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
							</svg>
						</button>
					) : null}
				</div>
				...
				<div className="product-content-cover-main-global-wrapper" ref={ContainerRef}>
					...
					<div className="product-content-cover-main-nav">
						<button
							className="product-content-cover-main-nav__item prev"
							onClick={onClickPrev}
						>
							<svg
								width="37"
						...
						<button
							className="product-content-cover-main-nav__item next"
							onClick={onClickNext}
						>
							<svg
								width="37"
