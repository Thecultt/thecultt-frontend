...
const FaqBuyers: React.FC = () => {
    const tabs: { title: string; description: string }[] = [
        ...
        },
        {
			...
			<br />
			<br />
			1. Приехать в нашу клиентскую зону,  расположенную прямо в нашем офисе. Адрес: г. Москва, ул. Трубная, д. 25, к. 3. Примерка в клиентской зоне доступна ежедневно с 10:00 до 21:00. Нужна <a href="https://calendly.com/thecultt/visit?month=2024-01">предварительная запись</a>. На примерку у вас будет 30 минут.
