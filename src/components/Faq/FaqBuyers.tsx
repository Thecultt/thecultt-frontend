...
const FaqBuyers: React.FC = () => {
    const tabs: { title: string; description: string }[] = [
        ...
        },
        {
			...
			<br />
			- для оплаченных и оформленных заказов с самовывозом. Заказ можно забрать по адресу: Москва, ул. Трубная 23с2.
			<br />
        ...
        },
        {
			...
			<br />
			<br />
			1. Воспользоваться услугой доставки с примеркой с помощью курьера THE CULTT.
			<br />
			Закажите доставку по удобному вам адресу в пределах МКАД (не более 2 сумок/пар обуви и не более 4 товаров в одном заказе). Вы сможете принять решение о покупке после примерки. Курьер заранее согласует с вами время доставки в промежутке с 11 до 21, с понедельника по воскресенье. На примерку у вас будет 15 минут. Курьер сможет принять оплату банковской картой (по безопасной ссылке). 
			<br />
			<br />
			Стоимость услуги — 600₽, даже если после примерки вы отказались от заказа или его части.
			<br />
			<br />
			2. Приехать в нашу клиентскую зону, расположенную прямо в нашем офисе.
			<br />
			<strong>Внимание! Клиентская зона закрыта с 10.07. Это временно — мы обновляем пространство. Как только запись в клиентскую зону откроется снова, мы пришлем зарегистрированным пользователям уведомление.</strong>
			`,
        },
        {
