	...
	const tabs: { title: string, description: string }[] = [
		{
			...
			description: `
			Мы предоставляем премиальный сервис и берем весь процесс продажи на себя.
			<br />
			<br />
			От вас лишь требуется оставить заявку на сайте, согласовать вариант сотрудничества и сумму продажи с менеджером THE CULTT, а затем передать вещь  нашему курьеру.
			<br />
			<br />
		...
		},
		{
			...
			Мы работаем с определенными брендами. Ознакомиться со списком можно по <a href="">ссылке</a>.
			`,
		},
		{
