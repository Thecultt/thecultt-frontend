...
const CabinetFavoritesShare: React.FC = () => {
	...
	let url = `https://thecultt.com/favorites/${user.user_wishlist_link}?utm_source=website&utm_medium=favorites&utm_campaign=selection`
	...
	return (
		<>
			<Popup
				state={statePopup}
				setState={() => setStatePopup(!statePopup)}
			>
				<div className="cabinet-favorites-share-popup">
					<h2 className="cabinet-favorites-share-popup__title">
						Поделитесь желаниями
					</h2>

					<p className="cabinet-favorites-share-popup__subtitle">
						Отправьте эту ссылку вашим друзьям
					</p>

					<p className="cabinet-favorites-share-popup__link">
						{url}
					</p>

					<button className={`${statePopupCopy ? "btn-regular" : "btn"} cabinet-favorites-share-popup__btn`} onClick={onClickCopyUrl}>
