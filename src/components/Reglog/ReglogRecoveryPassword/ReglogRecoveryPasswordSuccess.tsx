...
const ReglogRecoveryPasswordSuccess: React.FC = () => {
	return (
		<div className="reglog-content-text">
			...
			<p className="reglog-content-text__description">
				В случае возникновения проблем с авторизацией на сайте, напишите нам в поддержку в телеграмм <b>@thecultt_help_it</b>
			</p>

			<div className="reglog-content-text-btns">
				<a href='https://t.me/thecultt_help_it' className="btn-regular reglog-content-text-btns__btn">
					Связаться с нами
				...
				<button className="btn reglog-content-text-btns__btn" onClick={() => window.location.hash = ""}>
					Пропустить
				</button>
			</div>
		</div>
...
export default ReglogRecoveryPasswordSuccess