...
import VisitImageMedia from "../../../assets/images/visit-media.jpg";
		...
		<>
			...
			<div className="home-visit-media" style={{ backgroundImage: `url('${VisitImageMedia}')` }}>
				<div className="home-visit-media-text">
					<h2 className="home-visit-media-text__title">
						Забронируйте свой визит в THE CULTT!
					</h2>
					...
					<Link
						to="/visit"
						className="btn-regular white home-visit-media-text__btn"
					>
						Перейти
					</Link>
				</div>
