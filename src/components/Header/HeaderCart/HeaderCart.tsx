...
const HeaderCart: React.FC = () => {
    ...
    const {isVisibleMessage} = useTypedSelector(({cart}) => cart);
    ...
    return (
        <div className="header-block-cart-wrapper" ref={PopupRef}>
            <div className="header-block-cart" onClick={openModarCart}>
                <button
                    className={`header-block-cart__icon ${
                        state ? "active" : ""
                    }`}
                >
                    <svg
                    ...
                    >
                        <rect width="38" height="37.7778" rx="18.8889" />
                        <path
