...
import { HeaderCart, HeaderUser, HeaderHoverMenu, HeaderMedia } from "../";
			...
			<header className="header">
				<div className="container">
					<div className="header-wrapper">
						...
						<HeaderHoverMenu {...currentInfoMenu} isOpenHoverMenu={isOpenHoverMenu} onOpen={() => setIsOpenHoverMenu(true)} onClose={() => setIsOpenHoverMenu(false)} />
					</div>
				</div>
			</header>
