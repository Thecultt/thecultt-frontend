    ...
    return (
        <CatalogFiltersBlockWrapper title="Бренды">
            ...
            {search === "" ? (
                <>
                    <div
                        className={`catalog-filters-block-content-more ${
                            isAllVisible ? "visible" : ""
                        }`}
                    >
                        {brands.length
                            ? brands
                                  .slice(0, isAllVisible ? brands.length : 3)
                                  .map((brand, index) => (
                                      <div
                    ...
                    {isAllVisible ? (
                        <button
                            className="catalog-filters-block-content-checkbox__btn active"
                        ...
                        <button
                            className="catalog-filters-block-content-checkbox__btn"
                            onClick={toggleIsAllVisibleOnClick}
                        >
                            Больше
                            <svg
