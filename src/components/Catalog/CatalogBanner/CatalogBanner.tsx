        ...
        <div className="catalog-banner">
            ...
            <div className="catalog-banner-text">
                ...
                <p className="catalog-banner-text__description">
                    Примерьте сумки и аксессуары лучших дизайнеров из коллекции
                    THE CULTT или встретьтесь с нашим экспертом, чтобы узнать,
                    сколько вы сможете заработать на своих украшениях.
                </p>
