							...
							{query.getAll("selections").length == 1 ? (
								query.get("selections") == 5 ? (
									<div className="catalog-banner">
										<div
											className="catalog-banner-image"
											style={{ backgroundImage: `url("${CatalogBannerImageItbag}")` }}
										></div>
									...
									query.get("selections") == 6 ? (
										<div className="catalog-banner">
											<div
												className="catalog-banner-image"
												style={{ backgroundImage: `url("${CatalogBannerImageInvest}")` }}
											></div>
								...
								query.getAll("categories").length === 1 && query.get("categories") === "Сумки" ? (
									<div className="catalog-banner">
										...
										<div className="catalog-banner-text">
											...
											<Link to="/catalog?categories=Сумки&availability=Доступно&availability=На+примерке&availability=Нет+в+наличии&boutique=false&price_drop=false&selections=5" className="btn catalog-banner-text__btn">
