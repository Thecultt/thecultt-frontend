...
interface CatalogGoodsBlockProps {
    outStock?: boolean;
}

const CatalogGoodsBlock: React.FC<CatalogGoodsBlockProps> = ({outStock}) => {
    return (
        <div className="catalog-goods-block">
            <div className="catalog-goods-block-cover">
                <div className="catalog-goods-block-cover-arrow prev">
                    <svg
                        width="9"
                        height="16"
                        viewBox="0 0 9 16"
                ...
                <div className="catalog-goods-block-cover-arrow next">
                    <svg
                        width="9"
                        height="16"
                        viewBox="0 0 9 16"
                ...
                <div className="catalog-goods-block-cover-favorite">
                    <svg
                        width="19"
                        height="16"
                        viewBox="0 0 19 16"
                    ...
                    <span className="catalog-goods-block-cover-favorite__count">
                        12
                    </span>
                </div>
                <div className="catalog-goods-block-cover-dots">
                    <div className="catalog-goods-block-cover-dots-item"></div>
                    <div className="catalog-goods-block-cover-dots-item active"></div>
                    <div className="catalog-goods-block-cover-dots-item"></div>
                    <div className="catalog-goods-block-cover-dots-item"></div>
                </div>
                <div
                    className="catalog-goods-block-cover-image"
                    style={{backgroundImage: `url("${GoodsImage}")`}}
                ></div>
            </div>

            <div className="catalog-goods-block-text">
                <p className="catalog-goods-block-text__brand">Gucci</p>

                <h3 className="catalog-goods-block-text__model">
                    MINI BUCKET BAG
                </h3>

                {outStock ? (
                    <>
                        <span className="catalog-goods-block-text__outstock">
                            Нет в наличии
                            <svg
                                width="24"
                                height="24"
                        ...
                        <button className="btn-regular small black catalog-goods-block-text__btn">
                            Лист ожидания
                        </button>
                    </>
                ) : (
                    <>
                        <div className="catalog-goods-block-text-state">
                            <span className="catalog-goods-block-text-state__subtitle">
                                Состояние
                            </span>

                            <span className="catalog-goods-block-text-state__title">
                                <svg
                                    viewBox="0 0 11 12"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="catalog-goods-block-text-priceretail">
                            <p className="catalog-goods-block-text-priceretail__message">
                                <span>Цена ретейла</span>: аксессуар не был в
                                носке, фирменные бирки сохранены или
                                отсутствуют.
                            </p>

                            <span className="catalog-goods-block-text-priceretail__subtitle">
                                Цена ретейла:
                            </span>

                            <span className="catalog-goods-block-text-priceretail__title">
                                180 000 ₽
                                <svg
                                    width="24"
                                    height="24"
                        ...
                        <h3 className="catalog-goods-block-text__price">
                            142 000 ₽
                        </h3>

                        <button className="btn small catalog-goods-block-text__btn">
                            Добавить в корзину
                        </button>
                    </>
                )}
...
export default CatalogGoodsBlock;
