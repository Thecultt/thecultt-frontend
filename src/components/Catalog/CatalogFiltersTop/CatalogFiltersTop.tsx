		...
		<div className="catalog-filters-top">
			<div className="catalog-filters-top-media-btn">
				<div className="catalog-filters-top-media-btn-filters-wrapper">
					<button className="catalog-filters-top-media-btn__btn" onClick={() => setIsOpenFiltersMedia(!isOpenFiltersMedia)}>
						Фильтры
						...
						<svg viewBox="0 0 33 27" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<rect x="19.125" y="1.875" width="9.75" height="9.75" rx="4.875" fill="#F1EDE8" stroke="#202020" strokeWidth="2.25" />
							<path d="M1.5 20.25L31.5 20.25" stroke="#202020" strokeWidth="2.25" strokeLinecap="round" />
							<rect x="4.125" y="15.375" width="9.75" height="9.75" rx="4.875" fill="#F1EDE8" stroke="#202020" strokeWidth="2.25" />
						</svg>
					</button>
				</div>
