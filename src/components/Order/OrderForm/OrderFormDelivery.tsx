...
const deliveryItemsRussiaMoscow: { title: string; description: string, price: number }[] = [
	{
		title: "Примерка",
		description:
...
const deliveryItemsRussia: { title: string; description: string, price: number }[] = [
	{
...
const deliveryItemsSng: { title: string; description: string, price: number }[] = [
	{
...
const deliveryItemsGlobal: { title: string; description: string, price: number }[] = [
	{
...
const OrderFormDelivery: React.FC = () => {
	...
	const onClickSetCurrentDelivery = (delivery: { title: string, price: number }) => {
			...
			<div className="order-form-block-checkboxs-wrapper">
				{currentCountry_lowerCase === "россия" && currentCity_lowerCase.indexOf("москва") !== -1 ? deliveryItemsRussiaMoscow.map((item, index) => (
					<div
						...
						onClick={() => onClickSetCurrentDelivery({ title: item.title, price: item.price })}
					>
						<Field
