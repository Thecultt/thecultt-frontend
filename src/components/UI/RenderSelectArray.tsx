...
const RenderSelectArray: React.FC<RenderSelectArrayProps> = ({ label, items, disabled, input, meta: { form, dispatch, initial } }) => {
	const [state, setState] = React.useState<boolean>(false);
	const [currentItems, setCurrentItems] = React.useState<{ [key: string]: string }>({});
