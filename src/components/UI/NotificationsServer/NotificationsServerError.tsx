	...
	return (
		<div className={`notifications-server-item ${active ? "active" : ""}`}>
			...
			<div className="notifications-server-item-text">
				...
				<p className='notifications-server-item-text__subtitle'>
					Пожалуйста, перезагрузите страницу
				</p>
			</div>

			<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={onClickClose}>
