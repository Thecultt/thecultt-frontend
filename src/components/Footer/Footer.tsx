				...
				<div className="footer-wrapper">
					...
					<div className="footer-block footer-block-bottom">
						...
						<div className="footer-block-bottom-link">
							...
							<a href="https://storage.yandexcloud.net/the-cultt-docs/Офферта /Оферта для продавца 210324.pdf" className="footer-block-bottom-link__link">Публичная оферта продавца</a>
							<a href="https://storage.yandexcloud.net/the-cultt-docs/Офферта /Оферта для покупателя 210324.pdf " className="footer-block-bottom-link__link">Публичная оферта покупателя</a>
							{/* <Link
