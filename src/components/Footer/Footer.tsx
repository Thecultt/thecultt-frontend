					...
					<div className="footer-wrapper">
						...
						<div className="footer-block footer-block-bottom">
							...
							<div className="footer-block-bottom-link">
								...
								<a href="https://storage.yandexcloud.net/the-cultt-docs/03.05.2024/Оферта для продавца 240424.pdf" className="footer-block-bottom-link__link">Публичная оферта продавца</a>
