	...
	return (
		<form onSubmit={handleSubmit} className="footer-email-form">
			<div className="footer-email-form-input">
				...
				<button className='footer-email-form-input__btn'>
					<svg width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<path d="M11 20.9697L17 14.9697L11 8.96973" stroke="#202020" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
					</svg>
				</button>
			</div>
			...
			<p className="footer-email-form__subtitle">
				Подписываясь на рассылку, <a href="https://drive.google.com/file/d/1boXYWorAMhCifykbhO3UPu4iybSrEZNB/view">вы соглашаетесь получать</a>  информационные письма и персональные предложения на указанную почту.
			</p>
		</form>
	)
}
