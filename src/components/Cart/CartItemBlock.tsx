    ...
    return (
        ...
        >
            <div className="cart-item-content">
                {hiddenCheck ? null : (
                    <div className="cart-item-content-check" onClick={changeCheck}>
                        {checked ? (
                            <svg
                                width="20"
                                height="21"
                ...
                <Link to={`/product/${article}`}>
                    <div className="cart-item-content-text">
                        <p className="cart-item-content-text__brand">{manufacturer}</p>

                        <p className="cart-item-content-text__model">{name}</p>
            ...
            <div className="cart-item-remove" onClick={removeItem}>
