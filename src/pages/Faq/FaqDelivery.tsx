					...
					<div className="faq-text">
						...
						<div className="faq-text-block">
							...
							<div className="faq-text-block-description">
								<p>
									Мы работаем как интернет-магазин, что позволяет сохранять максимально выгодные для вас цены.
								</p>
								...
								<p>
									** Срок хранения оплаченного заказа - 5 рабочих дней.
								</p>

								<p><b>Платная доставка при примерке.</b></p>

								<p>
									Заказы с примеркой с доставкой по Москве внутри МКАД. Вы можете заказать доставку:
								</p>
								<ul>
									<li>не более 2 сумок;</li>
									<li>не более 4 аксессуаров;</li>
									<li>не более 3 пар обуви;</li>
									<li>если в заказе присутствуют несколько товарных категорий (сумки, обувь, аксессуары), то не более 4 товаров в одном заказе.</li>
								</ul>
								<p>
									Доставка осуществляется по Москве в пределах МКАД и принять решение о покупке после примерки. Лоты будут забронированы для вас на 24 часа и отправлены на примерку собственным курьером платформы THE CULTT.
								</p>
								<p>*Стоимость услуги — 600₽. Курьер находится в зоне видимости клиента. Время примерки - 15 минут. Если вам требуется больше времени (от 15 до 45 минут), то необходимо будет оплатить двойную стоимость примерки (1.200₽).</p>

								<p><b>Доставка по миру.</b></p>

								<p>Международная доставка по миру осуществляется службой EMS.</p>

								<p>*Стоимость доставки по миру — 5.000₽, </p>

								<p>**Стоимость доставки в страны СНГ — 2.000₽ (страны: Азербайджан, Армения, Беларусь, Казахстан, Кыргызстан, Молдавия, Таджикистан, Туркменистан, Узбекистан, Грузия).</p>

								<p><b>Важно! Размер таможенных пошлин определяется законодательством той страны, в которую осуществляется доставка.</b></p>

								<p><b>Примерка в клиентской зоне. </b></p>

								<p>Вы можете записаться для визита в нашу клиентскую зону в Москве для встречи с лотом мечты. Для оформления записи, необходимо заргеистрироваться по <a href="https://calendly.com/thecultt/visit" target="__blank">ссылке</a></p>

								<p>Менеджер свяжется накануне и сообщит о наличии изделий. При примерке в клиентской зоне лоты не резервируются за покупателем.</p>
							</div>
						</div>
						...
						<div className="faq-text-block">
							...
							<div className="faq-text-block-description">
								<p><b>Банковской картой при заказе на сайте.</b></p>

								<p>
									Вы можете оплатить заказ картами МИР, MasterCard*, Maestro*, UnionPay, YandexPay. Операция обеспечивается экварийнгом CloudPayments, что гарантирует полную безопасность платежа.
								</p>

								<p>
									Для оплаты (ввода реквизитов вашей карты) вы будете перенаправлены на платежный шлюз CloudPayments. Соединение с платежным шлюзом и передача информации осуществляется в защищенном режиме с использованием протокола шифрования SSL. Если ваш банк поддерживает технологию безопасного проведения интернет-платежей Verified by Visa, MasterCard SecureCode, MIR Accept, J-Secure, для проведения платежа также может потребоваться ввод специального пароля.
								</p>

								<p>Настоящий сайт поддерживает 256-битное шифрование. Конфиденциальность сообщаемой персональной информации обеспечивается CloudPayments. Введенная информация не будет предоставлена третьим лицам за исключением случаев, предусмотренных законодательством РФ. Проведение платежей по банковским картам осуществляется в строгом соответствии с требованиями платежных систем МИР, Visa Int., MasterCard Europe Sprl, JCB.</p>

								<p>При доставке с примеркой по Москве возможна оплата банковской картой по ссылке или QR-коду.</p>

								<p><b>*Оплата международными картами.</b></p>

								<p>Вы можете оплатить свой заказ на сайте международными картами Maestro, Mastercard, UnionPay. К оплате не принимается платежная система Visa, а также карты американских и украинских банков. </p>

								<p>Важно: товары, оплаченные международными картами, не подлежат возврату.</p>

								<p><b>Возможные причины отказа в оплате банковской картой:</b></p>

								<ul>
									<li>Перед оплатой заказа на сайте, пожалуйста, проверьте наличие средств на вашей карте.</li>
									<li>При оформлении заказа в страны СНГ обратите внимание на возможность поддержки банковской картой протокола 3ds</li>
									<li>К оплате не принимается платежная система Visa, а также карты американских и украинских банков. </li>
								</ul>
								...
								<ul>
									...
									<li>ваш банк установил ограничения на объем оплат, производимых в течение дня;</li>
									<li>ваш банк запретил проведение оплаты через интернет или MOTO-транзакции.</li>
								</ul>

								<p><b>Рассрочка и кредит.</b></p>

								<p>Вы можете оплатить заказ с помощью услуги беспроцентной рассрочки от банка Тинькофф или кредита от банков (МТС Банк, ОТП Банк Тинькофф Банк).  </p>

								<ul>
									<li>При оплате услугой "Рассрочка" общая сумма товара/товаров разбивается на 3 месяца на равные части.</li>
									<li>При оплате услугой "Кредит" сумма кредита и срок зависит от выбора ваших условий и будет известна после оформления.</li>
								</ul>

								<p>Данный вид оплаты возможен для товаров стоимостью не более 500.000₽.</p>

								<p>При возникновении проблем при оплате заказа картой вы можете написать менеджеру платформы THE CULTT, и мы поможем найти альтернативный способ оплаты.</p>

								<p><b>Яндекс Сплит.</b></p>

								<p>Вы можете воспользоваться услугой сервиса Яндекс Сплит для заказов на сумму менее 150 000 рублей. Сплит делит оплату на части, которые списываются в течение 2, 4 или 6 месяцев. Это не кредит и не рассрочка, поэтому у него нет длинных анкет, проверки кредитной истории и скрытых условий.</p>

								<p>Как оплатить частями?</p>

								<p>1. Выберите Сплит в способах оплаты</p>
								<p>2. Выберите комфортный срок</p>
								<p>3. Оплатите первую часть, и покупка сразу ваша. Остальные платежи спишутся позже — по графику.</p>

								<p>- Где посмотреть предстоящие платежи?</p>

								<p>Дату каждого платежа вы видите уже при оформлении, поэтому списания не станут неожиданностью. Также график списаний придёт вам в письме, а ещё его всегда можно посмотреть в приложении Яндекс Пэй. Все платежи спишутся с карты автоматически.</p>

								<p>- Как узнать доступную сумму для сплитования?</p>

								<p>Узнать доступный лимит для покупок можно в приложении Яндекс Пэй или на сайте <a href="https://split.yandex.ru" target="__blank">https://split.yandex.ru</a></p>

								<p>- Что если я захочу вернуть товар?</p>

								<p>Заказ, оплаченный в сплит, можно вернуть по стандартным условиям. А деньги, которые вы уже заплатили, Яндекс Сплит отправит обратно на карту.</p>
							</div>
						</div>
					</div>
