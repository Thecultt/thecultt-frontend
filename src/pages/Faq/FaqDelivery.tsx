                ...
                <div className="faq-wrapper">
                    ...
                    <div className="faq-text">
                        ...
                        <div className="faq-text-block">
                            <h4 className="faq-text-block__title">Какие есть варианты доставки?</h4>
                            <div className="faq-text-block-description">
                                <h3>1. Бесплатная доставка по России</h3>

                                <p>
                                    Доступна для оплаченных на сайте заказов с доставкой по России. Заказы с доставкой
                                    по России отправляются курьерской службой СДЭК до вашего адреса или пункта
                                    самовывоза (вы можете указать адрес ПВЗ в комментариях к заказу). Средний срок
                                    доставки — 2–10 дней в зависимости от региона.
                                </p>

                                <h3>2. Бесплатная доставка по Москве</h3>

                                <p>
                                    Доступна для оплаченных на сайте заказов с доставкой по Москве. Доставка
                                    осуществляется курьером THE CULTT, сроки доставки — 1–3 дня. Предварительно курьер
                                    свяжется и уточнит время своего прибытия.
                                </p>

                                <h3>3. Платная доставка для заказов с примеркой (по Москве)</h3>

                                <p>Вы можете заказать на примерку:</p>

                                <ul>
                                    <li>не более 2 сумок;</li>
                                    <li>не более 4 аксессуаров;</li>
                                    <li>не более 2 пар обуви;</li>
                                    <li>
                                        если в заказе присутствуют несколько товарных категорий (сумки, обувь,
                                        аксессуары), то не более 4 товаров в одном заказе.
                                    </li>
                                </ul>

                                <p>Правила пользования услугой:</p>

                                <p>1. Стоимость услуги – 600 Р.</p>
                                <p>2. Курьер находится в зоне видимости клиента.</p>
                                <p>3. Время примерки - 15 минут.</p>
                                <p>
                                    4. Если вам требуется больше времени (от 15 до 45 минут), то необходимо будет
                                    оплатить двойную стоимость примерки (1.200₽).
                                </p>

                                <p>Доставка осуществляется только по Москве в пределах МКАД.</p>
                                <p>
                                    Лоты будут забронированы для вас на 24 часа и отправлены на примерку курьером THE
                                    CULTT. Принять решение о покупке вы можете уже после примерки.
                                </p>

                                <h3>4. Самовывоз из офиса THE CULTT</h3>

                                <p>
                                    <b>
                                        Вы можете забрать заказ у в офисе THE CULTT с 10:00 до 21:00, без
                                        предварительной записи.
                                    </b>
                                </p>

                                <p>Мы находимся по адресу: Москва, ул. Трубная 23с2.</p>

                                <p>
                                    ВАЖНО: При оформлении самовывоза возврат доступен только в течение 7 дней после
                                    оплаты. Просим учитывать это при планировании посещения офиса.
                                </p>

                                <h3>5. Бесплатная примерка в клиентской зоне THE CULTT</h3>

                                <p>
                                    Вы можете записаться по ссылке на примерку в нашей клиентской зоне в Москве.
                                    Менеджер свяжется с вами накануне и сообщит о наличии изделий.
                                </p>

                                <p>ВАЖНО: При примерке в клиентской зоне лоты не резервируются за покупателем.</p>

                                <p>
                                    <strong>
                                        Внимание! Клиентская зона закрыта с 10.07. Это временно — мы обновляем
                                        пространство. Как только запись в клиентскую зону откроется снова, мы пришлем
                                        зарегистрированным пользователям уведомление.
                                    </strong>
                                </p>

                                <h3>6. Доставка по миру</h3>

                                <p>
                                    Международная доставка по миру осуществляется службой EMS. Стоимость доставки по
                                    миру — 6.000₽.
                                </p>

                                <p>
                                    Стоимость доставки в страны СНГ — 2.000₽ (страны: Азербайджан, Армения, Беларусь,
                                    Казахстан, Кыргызстан, Молдавия, Таджикистан, Туркменистан, Узбекистан, Грузия).
                                </p>

                                <p>
                                    ВАЖНО: Размер таможенных пошлин определяется законодательством той страны, в которую
                        ...
                        <div className="faq-text-block">
                            ...
                            <div className="faq-text-block-description">
                                <h3>1. Банковской картой при заказе на сайте</h3>

                                <p>
                                    Вы можете оплатить заказ картами МИР, MasterCard (российский банк),, VISA
                                    (российский банк), UnionPay, YandexPay на сайте при оформлении заказа.
                                </p>

                                <p>
                                    При доставке с примеркой по Москве возможна оплата банковской картой по ссылке или
                                    QR-коду.
                                </p>

                                <h3>2. Оплата международными картами</h3>

                                <p>
                                    Заказ можно оплатить на сайте только с российской карты банка. На данный момент
                                    система CloudPayments не принимает оплату с зарубежных карт, только российских и
                                    карт стран СНГ, если платежная система МИР.
                                </p>

                                <p>ВАЖНО: товары, оплаченные международными картами СНГ, не подлежат возврату.</p>

                                <h3>3. Рассрочка и кредит</h3>

                                <p>
                                    Вы можете оплатить заказ с помощью беспроцентной рассрочки от банка Тинькофф или
                                    кредита от банков МТС Банк, ОТП Банк Тинькофф Банк.
                                </p>

                                <p>
                                    При оплате услугой "Рассрочка" общая сумма товара/товаров разбивается на 3 месяца на
                                    равные части.
                                </p>

                                <p>
                                    При оплате услугой "Кредит" сумма кредита и срок зависит от выбора ваших условий и
                                    будет известна после оформления.
                                </p>

                                <p>ВАЖНО: Данный вид оплаты возможен для товаров стоимостью не более 500.000₽.</p>

                                <p>
                                    При возникновении проблем при оплате заказа картой вы можете написать менеджеру
                                    платформы THE CULTT, и мы поможем найти альтернативный способ оплаты.
                                </p>

                                <h3>4. Яндекс Сплит</h3>

                                <p>
                                    Сплит делит оплату на части, которые списываются в течение 2, 4 или 6 месяцев. Это
                                    не кредит и не рассрочка, поэтому у него нет длинных анкет, проверки кредитной
                                    истории и скрытых условий.
                                </p>

                                <p>Услуга действует для заказов на сумму не более 150 000 рублей.</p>

                                <h3>Как оплатить частями?</h3>

                                <p>1. Выберите Сплит в способах оплаты</p>
                                <p>2. Выберите комфортный срок</p>
                                <p>
                                    3. Оплатите первую часть, и покупка сразу ваша. Остальные платежи спишутся позже —
                                    по графику.
                                </p>

                                <h3>Где посмотреть предстоящие платежи?</h3>

                                <p>
                                    Дату каждого платежа вы видите уже при оформлении, поэтому списания не станут
                                    неожиданностью. Также график списаний придёт вам в письме, а ещё его всегда можно
                                    посмотреть в приложении Яндекс Пэй. Все платежи спишутся с карты автоматически.
                                </p>

                                <h3>Как узнать доступную сумму для сплитования?</h3>

                                <p>
                                    Узнать доступный лимит для покупок можно в приложении Яндекс Пэй или на сайте{' '}
                                    <a href="https://split.yandex.ru">https://split.yandex.ru</a>
                                </p>

                                <h3>Что если я захочу вернуть товар?</h3>

                                <p>
                                    Заказ, оплаченный в сплит, можно вернуть по стандартным условиям. А деньги, которые
                                    вы уже заплатили, Яндекс Сплит отправит обратно на карту.
                                </p>
                            </div>
                        </div>
                    </div>

                    <div className="faq-contact contact-block-wrapper">
                        ...
                        <a href="https://t.me/thecultthelp" className="contact-block hover-scale">
                            <div className="contact-block-content">
                                ...
                                <div className="contact-block-content-text">
                                    <h3 className="contact-block-content-text__title">Telegram</h3>
