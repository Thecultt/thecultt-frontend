					...
					<div className="faq-text">
						...
						<div className="faq-text-block">
							...
							<div className="faq-text-block-description">
								...
								<p>
									Доступна для оплаченных на сайте заказов с доставкой по России. Заказы с доставкой по России отправляются курьерской службой СДЭК до вашего адреса или пункта самовывоза (вы можете указать адрес ПВЗ в комментариях к заказу). Средний срок доставки — 2–10 дней в зависимости от региона.
								</p>
								...
								<p>
									Доступна для оплаченных на сайте заказов с доставкой по Москве. Доставка осуществляется курьером THE CULTT, сроки доставки — 1–3 дня. Предварительно курьер свяжется и уточнит время своего прибытия.
								</p>

								<h3>
									3. Платная доставка для заказов с примеркой (по Москве)
								</h3>

								<p>
									Вы можете заказать на примерку:
								</p>
								...
								<p>4. Если вам требуется больше времени (от 15 до 45 минут), то необходимо будет оплатить двойную стоимость примерки (1.200₽).</p>

								<p>Доставка осуществляется только по Москве в пределах МКАД.</p>
								<p>Лоты будут забронированы для вас на 24 часа и отправлены на примерку курьером THE CULTT. Принять решение о покупке вы можете уже после примерки.</p>

								<h3>
									4. Самовывоз из офиса THE CULTT
								</h3>

								<p><b>Вы можете забрать заказ у в офисе THE CULTT  с 11:00 до 21:00, без предварительной записи.</b></p>

								<p>Мы находимся по адресу: Москва, ул. Трубная 25с3.</p>

								<p>ВАЖНО: При оформлении самовывоза возврат доступен только в течение 7 дней после оплаты. Просим учитывать это при планировании посещения офиса.</p>

								<h3>
									5. Бесплатная примерка в клиентской зоне THE CULTT
								</h3>

								<p>Вы можете записаться по ссылке на примерку в нашей клиентской зоне в Москве. Менеджер свяжется с вами накануне и сообщит о наличии изделий.</p>
								...
								<p>Международная доставка по миру осуществляется службой EMS. Стоимость доставки по миру — 5.000₽.</p>
								...
								<p>ВАЖНО: Размер таможенных пошлин определяется законодательством той страны, в которую осуществляется доставка.</p>
							</div>
						</div>
						...
						<div className="faq-text-block">
							...
							<div className="faq-text-block-description">
								<h3>
									1. Банковской картой при заказе на сайте
								</h3>

								<p>Вы можете оплатить заказ картами МИР, MasterCard (российский банк),, VISA (российский банк), UnionPay, YandexPay на сайте при оформлении заказа.</p>

								<p>При доставке с примеркой по Москве возможна оплата банковской картой по ссылке или QR-коду.</p>

								<h3>
									2. Оплата международными картами
								</h3>

								<p>Заказ можно оплатить на сайте только с российской карты банка. На данный момент система CloudPayments не принимает оплату с зарубежных карт, только российских и карт стран СНГ, если платежная система МИР.</p>
								...
								<p>Вы можете оплатить заказ с помощью беспроцентной рассрочки от банка Тинькофф или кредита от банков МТС Банк, ОТП Банк Тинькофф Банк.</p>

								<p>При оплате услугой "Рассрочка" общая сумма товара/товаров разбивается на 3 месяца на равные части.</p>

								<p>При оплате услугой "Кредит" сумма кредита и срок зависит от выбора ваших условий и будет известна после оформления.</p>
								...
								<p>Сплит делит оплату на части, которые списываются в течение 2, 4 или 6 месяцев. Это не кредит и не рассрочка, поэтому у него нет длинных анкет, проверки кредитной истории и скрытых условий.</p>
								...
								<p>Узнать доступный лимит для покупок можно в приложении Яндекс Пэй или на сайте <a href="https://split.yandex.ru">https://split.yandex.ru</a></p>
