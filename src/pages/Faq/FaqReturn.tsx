                    ...
                    <div className="faq-text">
                        <div className="faq-text-block">
                            ...
                            <div className="faq-text-block-description">
                                ...
                                <p>*Возврат после примерки лота при курьере или в клиентской зоне невозможен.</p>

                                <p>
                                    **Товары из подборки "Архив Алены Долецкой" и оплаченные международными картами, не
                                    подлежат возврату.
                                </p>
                            </div>
                            ...
                            <div className="faq-text-block-description">
                                ...
                                <p>
                                    Адрес для возврата: Россия, город Москва, улица Трубная 23с2.
                                    <br />
