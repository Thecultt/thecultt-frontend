                ...
                <div className="about-wrapper">
                    ...
                    <div className="about-cultt">
                        ...
                        <div className="about-cultt-text">
                            ...
                            <p className="description about-cultt-text__description">
                                ...
                                Машей Манаевой, Таней Ермаковой. Он стал
                                синергией нашего разнопланового опыта в развитии
                                диджитал продуктов, персональном стайлинге,
                                развитии рекламной платформы и PR-сопровождении
                                локального бренда.
                            </p>
                        </div>
                    </div>
                    <div className="about-quote">
                        ...
                        <div className="about-quote-description">
                            <p className="description about-quote-description__description">
                                В THE CULTT, помимо люксового сегмента, вы
                                сможете найти сумки категории «винтаж» и модели
                                нишевых брендов, которые практически не
                                представлены в российском ресейле. На платформе
                                также выставлены украшения категории fashion
                                jewelry, fine jewerly, часы, очки, шелковые
                                платки, ремни и небольшие кожаные аксессуары.
                            </p>
                            ...
                            <p className="description about-quote-description__description">
                                ...
                                thecultt.com, а команда стилистов отбирает лоты
                                на соответствие актуальности моделей и брендов.
                                Вам не придется пролистывать тысячу товаров для
                                того, чтобы найти один интересный вариант.
                            </p>
                    ...
                    <div className="about-team">
                        ...
                        <p className="description about-team__description">
                            Познакомьтесь с основательницами THE CULTT. Анна
                            Автайкина, Дарья Зосименко, Мария Манаева и Татьяна
                            Ермакова всегда увлекались ресейлом. В определенный
                            момент они объединились, чтобы изменить культуру
                            потребления.
                        </p>
