				...
				<div className="about-wrapper">
					<div className="about-main hover-scale">
						<div className="about-main-text">
							...
							<p className="description about-main-text__description">
								Первая ресейл-платформа аксессуаров с
								селекционным подходом. Между собой мы называем
								наш проект просто «Культ», ведь основное
								направление — именно культовые сумки.
							</p>
						</div>
						<div
					...
					<div className="about-cultt">
						...
						<div className="about-cultt-text">
							...
							<p className="description about-cultt-text__description">
								Проект был запущен в октябре 2020 года четырьмя
								девушками: Аней Автайкиной, Дашей Зосименко,
								Машей Манаевой, Таней Ермаковой. <br /> <br />{" "}
								Он стал синергией нашего разнопланового опыта в
								развитии диджитал продуктов, персональном
								стайлинге, развитии рекламной платформы и
								PR-сопровождении локального бренда.
							</p>
						</div>
					</div>
					<div className="about-quote hover-scale">
						<div className="about-quote-title">
							...
							<h4 className="about-quote-title__title">
								Нас объединила идея создания ресейл-проекта. мы
								сами пользовались подобными сервисами и
								чувствовали нехватку именно селекционного
								подхода к аксессуарам. так и возникла идея
						...
						<div className="about-quote-description">
							<p className="description about-quote-description__description">
								Наше преимущество — в актуальной селекции. Все
								изделия проходят тщательную проверку на
								подлинность и состояние до публикации на
								платформе THE CULTT, а команда стилистов
								отбирает лоты на соответствие актуальности
								моделей и брендов. Вам не придется пролистывать
								тысячу товаров для того, чтобы найти один
								интересный вариант.
							</p>

							<p className="description about-quote-description__description">
								Мы всей душой любим сумки и считаем их знаковым
								предметом гардероба, способным сделать любой
								образ интересным и актуальным. Надеемся, что вы
								найдете сумку мечты именно у нас!
							</p>
						</div>
					</div>
					<div className="about-media">
						...
						<div className="about-media-logos">
							<a href="https://www.elle.ru/moda/vybor-elle-5-rossiiskikh-reseil-proektov-kotorym-my-doveryaem/" className="about-media-logos-item hover-scale" target="__blank">
								<img
									src={ElleLogo}
									alt=""
							...
							<a href="https://www.forbes.ru/svoi-biznes/464469-10-samyh-perspektivnyh-rossijskih-deatelej-mody-i-dizajna-moloze-30-let-2022" className="about-media-logos-item hover-scale" target="__blank">
								<img
									src={ForbesLogo}
									alt=""
									className="about-media-logos-item__image"
							...
							<a href="https://www.buro247.ru/news/style/29-mar-2022-the-cultt-retail-project-sale-sunglass.html" className="about-media-logos-item hover-scale" target="__blank">
								<img
									src={BuroLogo}
									alt=""
									className="about-media-logos-item__image"
							...
							<a href="https://incrussia.ru/concoct/the-cultt/" className="about-media-logos-item hover-scale" target="__blank">
								<img
									src={IncLogo}
									alt=""
									className="about-media-logos-item__image"
							...
							<a href="https://style.rbc.ru/items/624d9ce59a7947597b47b5e7" className="about-media-logos-item hover-scale" target="__blank">
								<img
									src={RbkLogo}
									alt=""
									className="about-media-logos-item__image"
							...
							<a href="https://theblueprint.ru/fashion/industry/ritejl-proekty" className="about-media-logos-item hover-scale" target="__blank">
								<img
									src={BluepintLogo}
									alt=""
									className="about-media-logos-item__image"
					...
					<div className="about-team">
						...
						<p className="description about-team__description">
							Познакомьтесь с основательнницами THE CULTT - Анна
							Автайкина, Дарья Зосименко, Мария Манаева и Таня
							Ермакова. Они всегда любили ресейл и объединились,
							чтобы вместе формировать КУЛЬТуру нового
							потребления.
						</p>
