                ...
                <div className="concierge-wrapper">
                    <div className="concierge-main">
                        <div className="concierge-main-text">
                            <h2 className="concierge-main-text__title">Консьерж-сервис</h2>

                            <p className="concierge-main-text__description">
                                Закажите консьерж-сервис с выездом на дом для продажи более 10 лотов, соответствующих
                                нашему <Link to="/sell/brands">бренд-листу</Link>.
                            </p>
                    ...
                    <div className="concierge-steps">
                        ...
                        <p className="concierge__description mb concierge-steps__description">
                            Мы создали удобный сервис, доступный для всех, кто хочет продать от 10 лотов - это могут
                            быть сумки, аксессуары, обувь. Услуга доступна только для жителей Москвы.
                        </p>
                    ...
                    <div className="concierge-services">
                        <h2 className="concierge__title mb">Преимущества консьерж-сервиса</h2>
