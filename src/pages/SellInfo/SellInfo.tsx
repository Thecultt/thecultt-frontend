					...
					<div className="sell-info-main hover-scale">
						<div className="sell-info-main-text">
							...
							<p className="sell-info-main-text__description">
								...
								дать им вторую жизнь. <br /> Мы поможем найти
								...
								*Размещайте объявление о продаже ваших ювелирных украшений на нашем сайте, и мы с удовольствием поможем вам найти подходящего покупателя!
							</p>
						...
						<div className="sell-info-cooperation-text hover-scale">
							...
							<div className="sell-info-cooperation-text-list">
								...
								<p className="sell-info-cooperation-text-list__subtitle">
									...
									товар приобретут.
									<br />
									*при продаже любого аксессуара, купленного в THE CULTT, мы предлагаем специальную комиссию -5 % от стандартной. Подробнее в разделе <Link to="/help/sellers">“Вопросы и ответы”</Link>.
								</p>
							</div>
						</div>
