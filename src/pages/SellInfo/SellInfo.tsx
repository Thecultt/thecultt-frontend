				...
				<div className="sell-info-wrapper">
					<div className="sell-info-main hover-scale">
						<div className="sell-info-main-text">
							<h2 className="sell-info-main-text__title">Продать Лот</h2>

							<p className="sell-info-main-text__description">
								У вас в гардеробе, вероятно, есть вещи, которые когда-то были любимее, чем сейчас. Самое
								время дать им вторую жизнь. <br /> Мы поможем найти покупателей для ваших сумок, обуви и
								аксессуаров.
								<br />
								<br />
								*Размещайте объявление о продаже ваших ювелирных украшений на нашем сайте, и мы с
								удовольствием поможем вам найти подходящего покупателя!
							</p>

							<LinkScroll to="sell-choice" spy={true} smooth={true} offset={-150} duration={1000}>
								<button className="btn sell-info-main-text__btn">Отправить заявку</button>
							</LinkScroll>
						</div>
						<div
					...
					<div className="sell-info-cooperation">
						<h2 className="sell-info__title sell-info-cooperation__title">Варианты сотрудничества</h2>
						<div className="sell-info-cooperation-text hover-scale">
							<h3 className="sell-info-cooperation-text__title">Продажа</h3>
							<p className="sell-info-cooperation-text__subtitle">
								Мы оценим ваш лот и предложим один из вариантов продажи:
							</p>

							<div className="sell-info-cooperation-text-list">
								<h4 className="sell-info-cooperation-text-list__title">Выкуп</h4>
								<p className="sell-info-cooperation-text-list__subtitle">
									мы согласуем условия, заберем лот и проверим его на подлинность в нашем офисе, затем
									сделаем выплату на карту.
								</p>
							</div>

							<div className="sell-info-cooperation-text-list">
								<h4 className="sell-info-cooperation-text-list__title">Продажа с комиссией</h4>
								<p className="sell-info-cooperation-text-list__subtitle">
									мы согласуем с вами стоимость лота и заберем его для дальнейшей продажи на нашем
									сайте. Вы получите выплату на карту после того, как ваш товар приобретут.
									<br />
									*при продаже любого аксессуара, купленного в THE CULTT, мы предлагаем специальную
									комиссию -5 % от стандартной. Подробнее в разделе{' '}
									<Link to="/help/sellers">“Вопросы и ответы”</Link>.
								</p>
							</div>
						</div>
						...
						<div className="sell-info-cooperation-types">
							<div className="sell-info-cooperation-types-block hover-scale">
								<h3 className="sell-info-cooperation-types-block__title">Обмен</h3>
								<p className="sell-info-cooperation-types-block__description">
									На нашем сайте старый лот можно не только продать, но и обменять на новый. Мы оценим
									лот и предложим депозит, соответствующий стоимости вашей вещи. Его можно будет
									потратить при покупке любого товара на нашей платформе.
								</p>

								<Link to="/exchange" className="sell-info-cooperation-types-block__link">
									Подробнее
								</Link>
							</div>
							...
							<div className="sell-info-cooperation-types-block hover-scale">
								...
								<p className="sell-info-cooperation-types-block__description">
									Премиальная услуга для продажи от 7 товаров за раз. Личный менеджер THE CULTT
					...
					<div className="sell-info-steps">
						<h2 className="sell-info__title sell-info-steps__title">Как это работает?</h2>
						...
						<div className="sell-info-steps-blocks-wrapper">
							<div className="sell-info-steps-block">
								...
								<h3 className="sell-info-steps-block__title">Подайте заявку</h3>
								<p className="sell-info-steps-block__description">
									На сайте, в Telegram-боте THE CULTT или в нашей клиентской зоне в Москве.
								</p>
							</div>
							...
							<div className="sell-info-steps-block">
								...
								<h3 className="sell-info-steps-block__title">Передайте лот нам</h3>
								<p className="sell-info-steps-block__description">
									Мы возьмем весь процесс продажи на себя: подготовку лота к продаже, съемку,
									публикацию и поиск покупателя.
								</p>
							</div>
							...
							<div className="sell-info-steps-block">
								...
								<h3 className="sell-info-steps-block__title">Получите выплату</h3>
								<p className="sell-info-steps-block__description">
									Как только товар будет продан, вы получите выплату на указанные в личном кабинете
									реквизиты.
								</p>
							</div>
						</div>
					...
					<div className="sell-info-steps-media">
						<h2 className="sell-info__title sell-info-steps-media__title">Как это работает?</h2>
							...
							<div className="sell-info-steps-media-block">
								<div className="sell-info-steps-media-block-icon">
									...
									>
										...
										<path
											d="M20.301 28.5V14.827L17.32 16.631V14.442L20.301 12.66H22.292V28.5H20.301Z"
											fill="#F1EDE8"
										/>
									</svg>
								</div>

								<h3 className="sell-info-steps-media-block__title">Подайте заявку</h3>
					...
					<div className="sell-info-contact" id="sell-choice">
						<h2 className="sell-info__title">Выберите удобный для вас способ подачи заявки на продажу</h2>
						...
						<div className="sell-info-contact-blocks-wrapper">
							<div className="sell-info-contact-block hover-scale">
								<div className="sell-info-contact-block-top">
									...
									<h3 className="sell-info-contact-block-top__title">Через сайт</h3>
							...
							<div className="sell-info-contact-block hover-scale">
								<div className="sell-info-contact-block-top">
									...
									<h3 className="sell-info-contact-block-top__title">Через Telegram-bot</h3>
									<p className="sell-info-contact-block-top__subtitle">
							...
							<div className="sell-info-contact-block hover-scale">
								<div className="sell-info-contact-block-top">
									...
									<h3 className="sell-info-contact-block-top__title">В офисе</h3>
									<p className="sell-info-contact-block-top__subtitle">
										Передайте лично свои лоты на продажу без заполнения заявки
									</p>
								</div>
					...
					<div className="sell-info-service-one">
							...
							<div className="sell-info-service-one-block sell-info-service-one-block-brands hover-scale">
								<div className="sell-info-service-one-block-top">
									...
									<p className="sell-info-service-one-block-top__description">
										...
										продать ваши лоты максимально быстро. Команда THE CULTT оставляет за собой право
										кураторского отбора.
									</p>
								</div>
								<Link to="/sell/brands" className="sell-info-service-one-block__link">
									Открыть бренд-лист
								</Link>
							</div>
								...
								<div className="sell-info-service-one-block-top">
									<div className="sell-info-service-one-block-top-icon">
										...
										>
											...
											/>
											<path
												d="M22 4.26953L12 14.2795L9 11.2795"
												stroke="#285141"
												strokeWidth="2"
												strokeLinecap="round"
												strokeLinejoin="round"
									...
									<h3 className="sell-info-service-one-block-top__title">Оригинал</h3>
									<p className="sell-info-service-one-block-top__description">
										Мы не принимаем неоригинальные товары на продажу. Все лоты проходят проверку на
										подлинность. Если оригинальность лота не подтвердится, то вам придется уплатить
										штраф в размере стоимости аутентификации и самостоятельно забрать его.
									</p>
								</div>
							</div>
							...
							<div className="sell-info-service-one-block sell-info-service-one-block-state hover-scale">
								<div className="sell-info-service-one-block-top">
									<div className="sell-info-service-one-block-top-icon">
										...
										>
											<path
												d="M13 1.26953L16.708 8.83946L25 10.0608L19 15.9499L20.416 24.2695L13 20.3395L5.584 24.2695L7 15.9499L1 10.0608L9.292 8.83946L13 1.26953Z"
												stroke="#285141"
												strokeWidth="2"
												strokeLinecap="round"
												strokeLinejoin="round"
									...
									<h3 className="sell-info-service-one-block-top__title">Состояние</h3>
									<p className="sell-info-service-one-block-top__description">
										Мы принимаем аксессуары в хорошем или отличном состоянии. Это означает, что
										изделие должно быть без сильных потертостей, дыр и пятен, все элементы — в
										рабочем состоянии.
									</p>
								</div>
							</div>
						...
						<div className="sell-info-service-one-faq">
							<h3 className="sell-info-service-one-faq__title">Какие лоты мы принимаем?</h3>
							<p className="sell-info-service-one-faq__description">
								У нас действует селекционный подход. Сумки, обувь и аксессуары должны соответствовать
								трем ключевым критериям. Мы трепетно относимся к нашей селекции и надеемся на понимание,
								если предложенный товар не подойдет.
							</p>

							<Link to="/help/sellers" className="btn sell-info-service-one-faq__btn">
								Подробнее в FAQ
							</Link>
						</div>
					</div>
					...
					<div className="sell-info-service-two">
						...
						<div className="sell-info-service-two-blocks-wrapper">
							<div className="sell-info-service-two-block hover-scale">
								<h3 className="sell-info-service-two-block__title">Удобный сервис</h3>
								<p className="sell-info-service-two-block__description">
									Вам не придется думать об отправке товаров — курьер приедет за ними в любое удобное
									время и место. В личном кабинете вы можете отслеживать статус продаж, а также
									консультироваться с нами по любым вопросам в реальном времени.
								</p>
							</div>

							<div className="sell-info-service-two-block hover-scale">
								<h3 className="sell-info-service-two-block__title">Безопасность</h3>
								<p className="sell-info-service-two-block__description">
									Мы заключаем с вами договор и гарантируем безопасность банковских операций, хранения
									и доставки ваших аксессуаров.
								</p>
							</div>

							<div className="sell-info-service-two-block hover-scale">
								<h3 className="sell-info-service-two-block__title">Экономия времени</h3>
								<p className="sell-info-service-two-block__description">
									Мы оценим ваш лот, согласуем с вами его стоимость и заберем для дальнейшей продажи.
									Съемка товара, замеры, размещение на сайте, коммуникация с покупателями — все это мы
									берем на себя. Покупателям мы предлагаем дополнительные сервисы, например, примерку
									или покупку в рассрочку — это помогает ускорить сделку.
								</p>
							</div>

							<div className="sell-info-service-two-block hover-scale">
								<h3 className="sell-info-service-two-block__title">Скорость продажи</h3>
								<p className="sell-info-service-two-block__description">
									Мы поможем установить конкурентную цену, по которой товар найдет покупателя в
									наиболее короткие сроки. При формировании цены мы ориентируемся на индекс оценки
									предметов роскоши для повторной продажи (comprehensive luxury appraisal index for
									resale) и согласовываем финальную стоимость с продавцом.
								</p>
							</div>
						</div>
					</div>
