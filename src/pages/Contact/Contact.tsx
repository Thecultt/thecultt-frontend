            ...
            <div className="container">
                <div className="contact-wrapper">
                    ...
                    <div className="contact-block-wrapper">
                        <a href="tel:+7 499 992 80 47" className="contact-block hover-scale">
                            <div className="contact-block-content">
                                ...
                                <div className="contact-block-content-text">
                                    ...
                                    <span className="contact-block-content-text__subtitle">+7 499 992 80 47</span>
                                </div>
                            </div>
                        ...
                        <a href="https://t.me/thecultt_help_it" className="contact-block hover-scale">
                            <div className="contact-block-content">
                                <div className="contact-block-content-icon">
                                    <svg
                                        width="30"
                        ...
                        >
                            <div className="contact-block-content">
                                ...
                                <div className="contact-block-content-text">
                                    ...
                                    <span className="contact-block-content-text__subtitle">+7 995 788 46 50</span>
                                </div>
                            </div>
                        ...
                        <a href="mailto:hey@thecultt.com" className="contact-block hover-scale">
                            <div className="contact-block-content">
                                <div className="contact-block-content-icon">
                                    <svg
                                        width="30"
                                ...
                                <div className="contact-block-content-text">
                                    ...
                                    <span className="contact-block-content-text__subtitle">hey@thecultt.com</span>
                                </div>
                            </div>
                        ...
                        <div className="contact-block-office hover-scale">
                            ...
                            <p className="contact-block-office__description">
                                Мы находимся по адресу Трубная 23с2 (3 этаж, офис THE CULTT) ежедневно с 10:00 до 21:00.
                                Для посещения необходима регистрация!
                            </p>
                            <a
                                href="https://calendly.com/thecultt/visit?month=2024-01"
                                className="btn-regular contact-block-office__btn"
                                target="_blank"
                                rel="noreferrer"
                            >
                                Выбрать время
