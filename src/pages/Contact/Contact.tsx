            ...
            <div className="container">
                <div className="contact-wrapper">
                    <h2 className="contact__title">
                        Есть много причин <br /> связаться с нами
                    </h2>
                    <div className="contact-block-wrapper">
                        ...
                        <a
                            href="https://www.instagram.com/the.cultt/"
                            className="contact-block"
                        >
                            <div className="contact-block-content">
                                <div className="contact-block-content-icon">
                                    ...
                                    >
                                        <path
                                            d="M15.5 9.875C14.3875 9.875 13.2999 10.2049 12.3749 10.823C11.4499 11.4411 10.7289 12.3196 10.3032 13.3474C9.87744 14.3752 9.76604 15.5062 9.98308 16.5974C10.2001 17.6885 10.7359 18.6908 11.5225 19.4775C12.3092 20.2641 13.3115 20.7999 14.4026 21.0169C15.4938 21.234 16.6248 21.1226 17.6526 20.6968C18.6804 20.2711 19.5589 19.5501 20.177 18.6251C20.7951 17.7001 21.125 16.6125 21.125 15.5C21.1234 14.0086 20.5303 12.5788 19.4758 11.5242C18.4212 10.4697 16.9914 9.87655 15.5 9.875ZM15.5 19.25C14.7583 19.25 14.0333 19.0301 13.4166 18.618C12.7999 18.206 12.3193 17.6203 12.0355 16.9351C11.7516 16.2498 11.6774 15.4958 11.8221 14.7684C11.9667 14.041 12.3239 13.3728 12.8483 12.8483C13.3728 12.3239 14.041 11.9667 14.7684 11.8221C15.4958 11.6774 16.2498 11.7516 16.9351 12.0355C17.6203 12.3193 18.206 12.7999 18.618 13.4166C19.0301 14.0333 19.25 14.7583 19.25 15.5C19.25 16.4946 18.8549 17.4484 18.1516 18.1516C17.4484 18.8549 16.4946 19.25 15.5 19.25ZM21.125 3.3125H9.875C8.13509 3.31436 6.46697 4.00636 5.23667 5.23667C4.00636 6.46697 3.31436 8.13509 3.3125 9.875V21.125C3.31436 22.8649 4.00636 24.533 5.23667 25.7633C6.46697 26.9936 8.13509 27.6856 9.875 27.6875H21.125C22.8649 27.6856 24.533 26.9936 25.7633 25.7633C26.9936 24.533 27.6856 22.8649 27.6875 21.125V9.875C27.6856 8.13509 26.9936 6.46697 25.7633 5.23667C24.533 4.00636 22.8649 3.31436 21.125 3.3125ZM25.8125 21.125C25.8125 22.3682 25.3186 23.5605 24.4396 24.4396C23.5605 25.3186 22.3682 25.8125 21.125 25.8125H9.875C8.6318 25.8125 7.43951 25.3186 6.56044 24.4396C5.68136 23.5605 5.1875 22.3682 5.1875 21.125V9.875C5.1875 8.6318 5.68136 7.43951 6.56044 6.56044C7.43951 5.68136 8.6318 5.1875 9.875 5.1875H21.125C22.3682 5.1875 23.5605 5.68136 24.4396 6.56044C25.3186 7.43951 25.8125 8.6318 25.8125 9.875V21.125ZM23 9.40625C23 9.68438 22.9175 9.95626 22.763 10.1875C22.6085 10.4188 22.3889 10.599 22.1319 10.7055C21.8749 10.8119 21.5922 10.8397 21.3194 10.7855C21.0466 10.7312 20.796 10.5973 20.5994 10.4006C20.4027 10.204 20.2688 9.95338 20.2145 9.6806C20.1603 9.40781 20.1881 9.12506 20.2945 8.8681C20.401 8.61114 20.5812 8.39152 20.8125 8.237C21.0437 8.08247 21.3156 8 21.5938 8C21.9667 8 22.3244 8.14816 22.5881 8.41188C22.8518 8.6756 23 9.03329 23 9.40625Z"
                                            fill="#838383"
                                        />
                                    </svg>
                                </div>
                        ...
                        <div className="contact-block-office">
                            ...
                            <p className="contact-block-office__description">
                                ...
                                офис THE CULTT) с 10:00 до 18:00 пн-пт. <br /> Для
