						...
						<div className={`sell-info-brands-block`} key={`sell-info-brands-block-${category}`}>
							...
							<div className="sell-info-brands-block-subblock-item-wrapper">
								{arrayChunkSplit(categories[category], 4).map((col, index) => (
									<div className="sell-info-brands-block-subblock-item-col" key={`sell-info-brands-block-subblock-item-col-${index}`}>
										{col.map((brand) => (
											<p className={`sell-info-brands-block-subblock-item-col__item`} key={`sell-info-brands-block-subblock-${category}-col__item-${brand}`}>
												{brand}
											</p>
										))}
									</div>
