					...
					<div className="visit-main">
						...
						<div className="visit-main-text">
							...
							<p className="visit-main-text__description">
								Благодаря услуге бронирования визита вы сможете примерить заинтересовавшие вас
								аксессуары или обсудить варианты продажи своих лотов через наш сервис в спокойной
								обстановке. Наш менеджер проконсультирует вас и ответит на любые вопросы.
							</p>

							<div className="visit-main-text-btn">
								<a href="https://calendly.com/thecultt/visit?month=2024-06" className="btn visit-main-text-btn__btn">
									Хочу купить
								</a>

								<a href="https://calendly.com/thecultt/visitsellers" className="btn-regular visit-main-text-btn__btn">
									Хочу продать
								</a>
							</div>
						</div>
					...
					<div className="visit-service">
						...
						<div className="visit-service-block">
							...
							<p className="visit-service-block__subtitle">
								<ul>
									<li>
										Обратите внимание на критерии отбора и <Link to="/sell/brands">бренд-лист</Link>{' '}
									...
									<li>
										Наши эксперты оценят лоты, проведут аутентификацию и согласуют с вами условия.
									</li>
					...
					<div className="visit-office">
						<div className="visit-office-block">
							...
							<div className="visit-office-block-btn">
								<a href="https://calendly.com/thecultt/visit?month=2024-06" className="btn visit-office-block-btn__btn">
									Хочу купить
								</a>

								<a href="https://calendly.com/thecultt/visitsellers" className="btn-regular visit-office-block-btn__btn">
									Хочу продать
								</a>
							</div>
						</div>
